<?php 
	...
	echo " 
	<div class='lateral-scroll scroll'>
		<div class='x scroll'>
			<!-- Contenedor X -->
			<div class='contenedorx-login blur blur-blanco borde-azul'>
				<!-- Espacios -->
				<p></p>
				<!-- Logo cuadrado -->
				...
				<div class='tabla'>
					<!-- Titulo de la Tabla -->
					<p class='texto-simple'><br>Bienvenid@ a <strong>Mirai ASM</strong><br>¡Que tenga buen día!</p>
					<!-- Conlumna X -->
				</div>
			</div>
		</div>
