...
<head>
	<meta charset="UTF-8">
	<title>Agregar Matriculas (BdN)</title>
...
<form method="POST">
	...
	<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-verde transicion-corta">Agregar Matriculas</p>
		</div>
		<div class="y scroll scroll-verde">
			<div class="contenedorx blur blur-blanco borde-verde">
					<div class="boton-menu imagen-matricula transicion-corta borde-verde"></div>

					<div class="formularioaux">
					<p class="sub-texto">Año <strong class="texto-rojo texto-borde-negro">*</strong></p>
					<input class="text-verde input input-blanco transicion-corta borde-verde" onkeypress="return solonumeros(event);" required name="ano" type="text" placeholder="2023"/>
		...
		<?php 
	include("ingresar-matricula.php");
	?>
	</div>
