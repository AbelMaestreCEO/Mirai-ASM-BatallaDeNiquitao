...
<head>
	<meta charset="UTF-8">
	<title>Eliminar Matrícula (BdN)</title>
...
<form method="POST">
	...
	<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-verde transicion-corta">Seleccione una Seccion a ELIMINAR</p>
		</div>
	<div class="y scroll scroll-azul">
		<div class="contenedorx blur blur-blanco borde-azul">
		<div class="boton-menu imagen-matricula transicion-corta borde-azul"></div>
			<div class="formularioaux">
	    	    <p class="sub-texto">Matrícula <strong class="texto-rojo texto-borde-negro">*</strong></p>
	    	    <select name="id" class="pointer-verde input input-blanco borde-morado">
					<?php 
					include("../../con_db.php");
