...
<head>
	<meta charset="UTF-8">
	<title>Decisión Sección (BdN)</title>
...
<!-- Cuerpo -->
	...
	<div class="z zp-salon blur blur-blanco scroll scroll-verde borde-verde">
		...
		<!-- Gran Contenedor V -->
		<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-verde transicion-corta">Seleccione una categoría a INGRESAR</p>
		</div>
		<!-- Primer Grupo X -->
		<div class="x scroll scroll-verde">
			...
			<div class="contenedorx blur blur-blanco borde-verde">
				...
				<!-- Boton Blanco -->
				<a href="eliminar-secciones.php" class="boton boton-activo boton-verde transicion-corta borde-verde">Sección</a>
				<!-- Tabla X -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
					...
					<div class="columna">
						...
						<p class="texto-simple">Profesor Guía: OBLIGATORIO.</p>
						<!-- Fila X -->
						<div class="fila">
							<!-- División -->
							<hr class="blur-azul">
							<!-- Texto de la fila -->
							<p class="texto-simple">Salón: OBLIGATORIO.</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="contenedorx blur blur-blanco borde-verde">
				...
				<div class="boton-menu imagen-seccion transicion-corta borde-verde"></div>
				<!-- Boton azul -->
				<a href="eliminar-salones.php" class="boton boton-activo boton-verde transicion-corta borde-verde">Salón</a>
				<!-- Tabla x -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
					<!-- Titulo de la tabla -->
					<p class="texto-simple">Salones</p>
					<!-- Columna -->
					<div class="columna">
						<!-- División x -->
						<hr class="blur-azul">
