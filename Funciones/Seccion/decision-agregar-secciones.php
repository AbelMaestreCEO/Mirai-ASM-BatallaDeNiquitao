	...
	<div class="z zp-salon blur blur-blanco scroll scroll-verde borde-verde">
		...
		<div class="x scroll scroll-verde">
			...
			<div class="contenedorx blur blur-blanco borde-verde">
				...
				<!-- Boton Blanco -->
				<a href="agregar-secciones.php" class="boton boton-activo boton-verde transicion-corta borde-verde">Sección</a>
				<!-- Tabla X -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
			...
			<div class="contenedorx blur blur-blanco borde-verde">
				...
				<div class="boton-menu imagen-seccion transicion-corta borde-verde"></div>
				<!-- Boton azul -->
				<a href="agregar-salones.php" class="boton boton-activo boton-verde transicion-corta borde-verde">Salón</a>
				<!-- Tabla x -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
