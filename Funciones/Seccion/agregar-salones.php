...
<head>
	<meta charset="UTF-8">
	<title>Agregar Salones (BdN)</title>
	...
	<div class="v">
		...
		<div class="y scroll scroll-verde">
			<div class="contenedorx blur blur-blanco borde-verde">
					...
					<input class="text-verde input input-blanco transicion-corta borde-verde" required name="id" type="text" placeholder="A-01">
				</div>
			</div>
		</div>
		<div class="v">
