...
<head>
	<meta charset="UTF-8">
	<title>Batalla de Niquitao - Mensualidades</title>
	...
	<div class="z zp-estudiante1 blur blur-blanco scroll scroll-rojo borde-rojo">
		...
		<div class="y scroll scroll-rojo">
			...
			<div class="contenedory blur blur-blanco borde-rojo">
				...
				<p></p>
				<!-- Logo circular -->
				<div class="boton-central-grande imagen-mensualidad transicion-corta borde-rojo">
				...
				<div class="tabla">
					...
					<div class="columna">
						...
						<div class="fila">
							...
							<p class="titulo-seccion">Mensualidades</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="x scroll scroll-rojo">
			...
			<div class="contenedorx blur blur-blanco borde-rojo">
				...
				<p></p>
				<!-- Logo cuadrado -->
				<div class="boton-menu imagen-mensualidad transicion-corta borde-rojo">

				</div>
				<!-- Boton Blanco -->
				<a href="#" class="boton boton-activo boton-rojo transicion-corta borde-rojo">Mensualidades</a>
				<!-- Tabla X -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
					<!-- Titulo de la Tabla -->
					<p class="texto-simple">Mensualidades</p>
					<!-- Conlumna X -->
					<div class="columna">
						<!-- División -->
						<hr class="blur-azul">
