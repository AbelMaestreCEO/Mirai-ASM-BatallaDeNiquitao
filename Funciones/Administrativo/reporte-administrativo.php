...
<head>
    ...
    <title>Reporte Administrativos</title>
</head>
<body class="fondo-blanco">
<?php
include '../../con_db.php';

$resultado = mysqli_query($conex, "CALL sp_reporte_usuario()");

?>
    <!-- Encabezado incio -->
    <?php include '../Reportes/encabezado-reportes.php'; ?>
      <p class="titulo-reporte fuente-sistema text-center bold italic">Listado de Usuarios</p>
