...
<head>
	<meta charset="UTF-8">
	<title>Batalla de Niquitao - Contratos</title>
	...
	<div class="z zp-interior blur blur-blanco scroll scroll-azul borde-azul">
		...
		<div class="y scroll scroll-azul">
			...
			<div class="contenedory blur blur-blanco borde-azul">
				...
				<p></p>
				<!-- Logo circular -->
				<div class="boton-central-grande imagen-contrato transicion-corta borde-azul">
				...
				<div class="tabla">
					...
					<div class="columna">
						...
						<div class="fila">
							...
							<p class="titulo-seccion">Contratos</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="x scroll scroll-azul">
			...
			<div class="contenedorx blur blur-blanco borde-azul">
				...
				<p></p>
				<!-- Logo cuadrado -->
				<div class="boton-menu imagen-contrato transicion-corta borde-azul">

				</div>
				<!-- Boton Blanco -->
				<a href="#" class="boton boton-activo boton-azul transicion-corta borde-azul">Contratos</a>
				<!-- Tabla X -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
					<!-- Titulo de la Tabla -->
					<p class="texto-simple">Contratos</p>
					<!-- Conlumna X -->
					<div class="columna">
						<!-- División -->
						<hr class="blur-azul">
