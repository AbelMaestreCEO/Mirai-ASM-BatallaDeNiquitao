...
<head>
	<meta charset="UTF-8">
	<title>Eliminar Contrato (BdN)</title>
...
<!-- Cuerpo -->
<form method="POST">
	<div class="z zp-estudiante1 blur blur-blanco scroll scroll-azul borde-azul">
		<?php include "../Formularios/Unicos/id.php";?>
		<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-azul transicion-corta">Es todo por ahora :)</p>
		</div>
		<?php 
	include("borrar-contrato.php");
	?>
	</div>
