...
<head>
	<meta charset="UTF-8">
	<title>Batalla de Niquitao - Plan Educativo</title>
	...
	<div class="z zp-salon blur blur-blanco scroll scroll-verde borde-verde">
		...
		<div class="y scroll scroll-verde">
			...
			<div class="contenedory blur blur-blanco borde-verde">
				...
				<p></p>
				<!-- Logo circular -->
				<div class="boton-central-grande imagen-materia transicion-corta borde-verde">
				...
				<div class="tabla">
					...
					<div class="columna">
						...
						<div class="fila">
							...
							<p class="titulo-seccion">Plan Educativo</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="x scroll scroll-verde">
			...
			<div class="contenedorx blur blur-blanco borde-verde">
				...
				<p></p>
				<!-- Logo cuadrado -->
				<div class="boton-menu imagen-materia transicion-corta borde-verde">

				</div>
				<!-- Boton Blanco -->
				<a href="#" class="boton boton-activo boton-verde transicion-corta borde-verde">Materias</a>
				<!-- Tabla X -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
					<!-- Titulo de la Tabla -->
					<p class="texto-simple">Materias</p>
					<!-- Conlumna X -->
					<div class="columna">
						<!-- División -->
						<hr class="blur-azul">
