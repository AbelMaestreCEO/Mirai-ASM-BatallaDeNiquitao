	...
	<div class="z zp-salon blur blur-blanco scroll scroll-verde borde-verde">
		...
		<div class="x scroll scroll-verde">
			...
			<div class="contenedorx blur blur-blanco borde-verde">
				...
				<!-- Boton Blanco -->
				<a href="agregar-plan.php" class="boton boton-activo boton-verde transicion-corta borde-verde">Pan de Estudio</a>
				<!-- Tabla X -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
			...
			<div class="contenedorx blur blur-blanco borde-verde">
				...
				<div class="boton-menu imagen-materia transicion-corta borde-verde"></div>
				<!-- Boton azul -->
				<a href="agregar-materias.php" class="boton boton-activo boton-verde transicion-corta borde-verde">Materia</a>
				<!-- Tabla x -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
