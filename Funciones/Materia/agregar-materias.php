...
<head>
	<meta charset="UTF-8">
	<title>Agregar Materias (BdN)</title>
...
<form method="POST">
	...
	<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-verde transicion-corta">Agregar Materias</p>
		</div>
		<div class="y scroll scroll-verde">
			<div class="contenedorx blur blur-blanco borde-verde">
					...
					<input class="text-verde input input-blanco transicion-corta borde-verde" onkeypress="return solotexto(event);" required name="materia" required type="text" placeholder="Castellano"/>
					<p class="sub-texto">Hora de Inicio <strong class="texto-rojo texto-borde-negro">*</strong></p>
					<input class="text-verde input input-blanco transicion-corta borde-verde" required name="horai" type="time" placeholder="8:00am">
					<p class="sub-texto">Hora de Fin <strong class="texto-rojo texto-borde-negro">*</strong></p>
					<input class="text-verde input input-blanco transicion-corta borde-verde" required name="horaf" type="time" placeholder="9:00am">
				</div>
			</div>
			<div class="contenedorx blur blur-blanco borde-verde">
					<div class="boton-menu imagen-materia transicion-corta borde-verde"></div>
