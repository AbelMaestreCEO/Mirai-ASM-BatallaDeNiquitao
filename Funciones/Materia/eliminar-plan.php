...
<head>
	<meta charset="UTF-8">
	<title>Eliminar Plan de Estudio (BdN)</title>
...
<form method="POST">
	...
	<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-verde transicion-corta">Ingrese un Plan de Estudio a ELIMINAR</p>
		</div>
