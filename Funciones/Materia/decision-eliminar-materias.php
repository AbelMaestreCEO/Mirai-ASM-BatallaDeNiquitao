...
<!-- Cuerpo -->
	...
	<div class="z zp-salon blur blur-blanco scroll scroll-verde borde-verde">
		...
		<!-- Gran Contenedor V -->
		<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-verde transicion-corta">Seleccione una categoría a Eliminar</p>
		</div>
		<!-- Primer Grupo X -->
		<div class="x scroll scroll-verde">
			...
			<div class="contenedorx blur blur-blanco borde-verde">
				...
				<!-- Boton Blanco -->
				<a href="eliminar-plan.php" class="boton boton-activo boton-verde transicion-corta borde-verde">Pan de Estudio</a>
				<!-- Tabla X -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
			...
			<div class="contenedorx blur blur-blanco borde-verde">
				...
				<div class="boton-menu imagen-materia transicion-corta borde-verde"></div>
				<!-- Boton azul -->
				<a href="eliminar-materias.php" class="boton boton-activo boton-verde transicion-corta borde-verde">Materia</a>
				<!-- Tabla x -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
