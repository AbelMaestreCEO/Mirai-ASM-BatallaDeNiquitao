...
<!-- Cuerpo -->
	...
	<div class="z zp-interior blur blur-blanco scroll scroll-azul borde-azul">
		...
		<!-- Gran Contenedor V -->
		<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-azul transicion-corta">Seleccione una categoría a CONSULTAR</p>
		</div>
		<!-- Primer Grupo X -->
		<div class="x scroll scroll-azul">
			...
			<div class="contenedorx blur blur-blanco borde-azul">
				...
				<!-- Boton Blanco -->
				<a href="consultar-notas1.php" class="boton boton-activo boton-azul transicion-corta borde-azul">Notas 1</a>
				<!-- Tabla X -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
					...
					<div class="columna">
						...
						<p class="texto-simple">Estudiante: OBLIGATORIO</p>
						<!-- Fila X -->
						<div class="fila">
							<!-- División -->
							<hr class="blur-azul">
							<!-- Texto de la fila -->
							<p class="texto-simple">Materia: OBLIGATORIO</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="contenedorx blur blur-blanco borde-azul">
				...
				<div class="boton-menu imagen-nota transicion-corta borde-azul"></div>
				<!-- Boton azul -->
				<a href="consultar-notas2.php" class="boton boton-activo boton-azul transicion-corta borde-azul">Notas 2</a>
				<!-- Tabla x -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
