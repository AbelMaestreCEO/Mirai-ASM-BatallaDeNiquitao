...
<head>
	<meta charset="UTF-8">
	<title>Agregar Notas II (BdN)</title>
...
<form method="POST">
	...
	<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-azul transicion-corta">Agregar Notas (Estudiante II)</p>
		</div>
		<div class="y scroll scroll-azul">
			<div class="contenedorx blur blur-blanco borde-azul">
					...
					<input class="text-azul input input-blanco transicion-corta borde-azul" onkeypress="return solonumeros(event);" required name="estudiante" type="text" placeholder="CI: --.---.---">
					<p class="sub-texto">Nota <strong class="texto-rojo texto-borde-negro">*</strong></p>
					<input class="text-azul input input-blanco transicion-corta borde-azul" onkeypress="return solonumeros(event);" required name="nota" type="numer" placeholder="18.50">
				</div>
			</div>
			<div class="contenedorx blur blur-blanco borde-azul">
				<div class="boton-menu imagen-nota transicion-corta borde-azul"></div>
				<div class="formularioaux">
					...
					<input class="text-azul input input-blanco transicion-corta borde-azul" name="observacion" type="text" placeholder="Cualquier cosa...">
				</div>
			</div>
		</div>
		<div class="v">
