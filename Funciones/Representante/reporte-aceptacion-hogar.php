...
<head>
	<meta charset="UTF-8">
	<title>Generar Aceptación (BdN)</title>
...
<form method="POST">
	<div class="z zp-interior blur blur-blanco scroll scroll-azul borde-rojo">
		...
		<div class="y scroll scroll-rojo">
			<div class="contenedorx blur blur-blanco borde-rojo">
				<div class="boton-menu imagen-representante transicion-corta borde-rojo"></div>
					...
					<p class="sub-texto">Inicio <strong class="texto-rojo texto-borde-negro">*</strong></p>
					<input class="text-rojo input input-blanco transicion-corta borde-rojo" name="inicio" required type="date" placeholder=""/>
				</div>
			</div>
		</div>
		<div class="v">
		...
		<?php include("reporte-aceptacion2.php");?>
	</div>
