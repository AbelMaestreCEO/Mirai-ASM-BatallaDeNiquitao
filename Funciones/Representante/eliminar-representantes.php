...
<head>
	<meta charset="UTF-8">
	<title>Eliminar Representante (BdN)</title>
...
<form method="POST">
	<div class="z zp-estudiante1 blur blur-blanco scroll scroll-rojo borde-rojo">
		<div class="v">
				<p class="titulo-pagina blur blur-blanco borde-rojo transicion-corta">ELIMINAR Representante</p>
		</div>
		...
		<?php 
	include("borrar-representantes.php");
	?>
	</div>
