...
<head>
	<meta charset="UTF-8">
	<title>Actualizar Representante (BdN)</title>
...
<form method="POST">
	...
	<?php include "../Formularios/datos.php"; include "../Formularios/contactos.php"; include "../Formularios/direccion.php";?>
		<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-rojo transicion-corta">Representante</p>
		</div>
		<div class="x scroll scroll-rojo">
			<div class="contenedorx blur blur-blanco borde-rojo">
				...
				<p class="sub-texto">Mensualidad<strong class="texto-rojo texto-borde-negro"> X</strong></p>
				<select name="mensualidad" class="pointer-rojo input input-blanco borde-morado">
				<?php 
				include("../../con_db.php");
				...
				<p class="sub-texto">Tipo <strong class="texto-rojo texto-borde-negro">*</strong></p>
				<select name="tipo" class="pointer-rojo input input-blanco borde-morado">				
		...
		<?php 
	include("cambiar-representantes.php");
	?>
	</div>
