...
if(isset($_POST['register'])){
	...
	$consulta = "CALL sp_insertar_representante ('$cedula','$nombre','$apellido','$fecha','$sexo','$tipo','$correo1','$correo2',@idcorreos,'$telefono1','$telefono2',@idtelefonos,'$casa','$calle','$vereda','$piso','$edificio','$punto','$parroquia',@iddireccion)";
