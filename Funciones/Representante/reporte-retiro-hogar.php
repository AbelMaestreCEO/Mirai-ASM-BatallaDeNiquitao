...
<head>
	<meta charset="UTF-8">
	<title>Generar Retiro (BdN)</title>
...
<!-- Cuerpo -->
<form method="POST">
	<div class="z zp-interior blur blur-blanco scroll scroll-azul borde-rojo">
	<?php include "../Formularios/Unicos/cedula.php";?>
		<div class="y scroll scroll-rojo">
			<div class="contenedorx blur blur-blanco borde-rojo">
					<div class="boton-menu imagen-representante transicion-corta borde-rojo"></div>
					<div class="formularioaux">
					<p class="sub-texto">Plan de Estudio <strong class="texto-rojo texto-borde-rojo">*</strong></p>
					<select name="plan" class="pointer-rojo input input-blanco borde-rojo">
					<?php 
						include("../../con_db.php");
					...
					<p class="sub-texto">Motivo <strong class="texto-rojo texto-borde-negro">*</strong></p>
					<input class="text-rojo input input-blanco transicion-corta borde-rojo" onkeypress="return solotexto(event);" name="motivo" required type="text" placeholder="Cambio de residencia"/>
					<p class="sub-texto">Expiración <strong class="texto-rojo texto-borde-negro">*</strong></p>
					<input class="text-rojo input input-blanco transicion-corta borde-rojo" name="expiracion" required type="date" placeholder="Cambio de residencia"/>
				</div>
			</div>
		</div>
		<div class="v">
		...
		<?php include("reporte-retiro2.php");?>
	</div>
