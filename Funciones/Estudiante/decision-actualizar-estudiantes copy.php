	...
	<div class="z zp-estudiante1 blur blur-blanco scroll scroll-rojo borde-rojo">
		...
		<div class="x scroll scroll-rojo">
			...
			<div class="contenedorx blur blur-blanco borde-rojo">
				...
				<!-- Boton Blanco -->
				<a href="actualizar-estudiantes-1c.php" disabled class="boton boton-activo boton-rojo transicion-corta borde-rojo">Datos</a>
				<!-- Tabla X -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
			...
			<div class="contenedorx blur blur-blanco borde-rojo">
				...
				<!-- Boton azul -->
				<a href="actualizar-estudiantes-2c.php" class="boton boton-activo boton-rojo transicion-corta borde-rojo">Datos</a>
				<!-- Tabla x -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
