...
<head>
	<meta charset="UTF-8">
	<title>Agregar Estudiante I (BdN)</title>
...
<form method="POST">
	...
	<?php include "../Formularios/datos-estudiante-1.php";?>
	<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-rojo transicion-corta">Estudiante I</p>
		</div>
		...
		<div class="v">
			...
			<?php 
	include("ingresar-estudiantes-1.php");
	?>
	</div>
