	...
	<div class="z zp-estudiante1 blur blur-blanco scroll scroll-rojo borde-rojo">
		...
		<div class="y scroll scroll-rojo">
			...
			<div class="contenedory blur blur-blanco borde-rojo">
				...
				<p></p>
				<!-- Logo circular -->
				<div class="boton-central-grande imagen-estudiante-1 transicion-corta borde-rojo">
				...
				<div class="tabla">
					...
					<div class="columna">
						...
						<div class="fila">
							...
							<p class="titulo-seccion">Matrícula Estudiantil</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="x scroll scroll-rojo">
			...
			<div class="contenedorx blur blur-blanco borde-rojo">
				...
				<!-- Boton Blanco -->
				<a href="reporte-estudiante-hogar.php" class="boton boton-activo boton-rojo transicion-corta borde-rojo">Listados</a>
				<!-- Tabla X -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
					<!-- Titulo de la Tabla -->
					<p class="texto-simple">Consultar listados</p>
					<!-- Conlumna X -->
					<div class="columna">
						<!-- División -->
						<hr class="blur-azul">
						<!-- Titulo de la columna -->
						<p class="texto-simple">Primaria:[]</p>
						<!-- Fila X -->
						<div class="fila">
							<!-- División -->
							<hr class="blur-azul">
							<!-- Texto de la fila -->
							<p class="texto-simple">Secundaria:[]</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="contenedorx blur blur-blanco borde-rojo">
				...
				<!-- Boton azul -->
				<a href="#" class="boton boton-activo boton-rojo transicion-corta borde-rojo">Viviendas</a>
				<!-- Tabla x -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
			...
			<div class="contenedorx blur blur-blanco borde-rojo">
				...
				<!-- Boton rojo -->
				<a href="#" class="boton boton-activo boton-rojo transicion-corta borde-rojo">Contactos</a>
				<!-- Tabla x -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
