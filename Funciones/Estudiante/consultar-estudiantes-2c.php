...
<head>
	<meta charset="UTF-8">
	<title>Consultar Estudiante 2 (BdN)</title>
...
<form method="POST">
	<div class="z zp-estudiante1 scroll scroll-rojo borde-rojo">
		<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-rojo transicion-corta">Consultar Estudiante 2</p>
		</div>
			<?php include("../Formularios/consultar-datos.php"); ?>
			<?php include("buscar-estudiante-2.php"); ?>
	</div>
