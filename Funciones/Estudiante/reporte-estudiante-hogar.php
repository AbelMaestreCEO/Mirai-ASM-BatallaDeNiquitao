...
<head>
	<meta charset="UTF-8">
	<title>Reporte Estudiantes (BdN)</title>
...
<!-- Cuerpo -->
<form method="POST">
	<div class="z zp-interior blur blur-blanco scroll scroll-rojo borde-rojo">
	<div class="v">
	<p class="titulo-pagina blur blur-blanco borde-rjo transicion-corta">Seleccione el Plan de Estudio</p>
</div>
<div class="y scroll">
	<div class="contenedorx blur blur-blanco borde-negro">
		<div class="boton-menu imagen-estudiante-1 transicion-corta borde-negro"></div>
		<div class="formularioaux">
			<p class="sub-texto">Plan de Estudio <strong class="texto-rojo texto-borde-negro">*</strong></p>
			<select name="id" class="pointer-rojo input input-blanco borde-rojo">
				<?php 
						include("../../con_db.php");
	    	    ...
	    	    <select name="seccion" class="pointer-rojo input input-blanco borde-rojo">
				<?php 
						include("../../con_db.php");
		...
		<?php include("reporte-estudiante2.php");?>
	</div>
