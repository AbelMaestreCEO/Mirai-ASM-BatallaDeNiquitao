...
<head>
	<meta charset="UTF-8">
	<title>Agregar Municipios (BdN)</title>
...
<form method="POST">
	...
	<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-morado transicion-corta">Agregar Municipios</p>
		</div>
		<div class="y scroll scroll-morado">
			<div class="contenedorx blur blur-blanco borde-morado">
					...
					<input class="text-morado input input-blanco transicion-corta borde-morado" onkeypress="return solotexto(event);" required name="municipio" type="text" placeholder="Simón Rodríguez">
					<p class="sub-texto">Estado <strong class="texto-rojo texto-borde-negro">*</strong></p>
					<select name="estado" class="pointer-morado input input-blanco borde-morado">
					<?php 
						include("../../con_db.php");
						$resultado = mysqli_query($conex, "CALL sp_listar_estado()");
		...
		<?php 
	include("ingresar-municipio.php");
	?>
	</div>
	...
	<div class="u">
		...
		<footer class="pie pie-registro blur blur-morado-suave borde-morado">
				...
				<ul class="menu-pie">
					...
					<!-- Boton atrás -->
					<li><a href="agregar-ciudades.php"><div class="pointer-morado boton-menu-superior imagen-atras transicion-corta borde-morado"></div></a></li>
					<!-- Boton Hogar -->
					...
					<!-- Boton adelante -->
					<li><a href="agregar-estados.php"><div class="pointer-morado boton-menu-superior imagen-adelante transicion-corta borde-morado"></div></a></li>
