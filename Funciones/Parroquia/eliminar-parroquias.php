...
<head>
	<meta charset="UTF-8">
	<title>Eliminar Parroquia (BdN)</title>
...
<form method="POST">
	...
	<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-morado transicion-corta">Eliminar Parroquia</p>
		</div>
		<div class="y scroll scroll-morado">
			<div class="contenedorx blur blur-blanco borde-morado">
					<div class="boton-menu imagen-parroquia transicion-corta borde-morado"></div>
