...
<head>
	<meta charset="UTF-8">
	<title>Agregar Parroquias (BdN)</title>
...
<body class="transicion-corta scroll cursor-morado">
	...
	<header>
		...
		<!-- Menú Horizontal -->
		<ul class="menu">
				<?php require_once "../menu-superior-1.php"; ?>
...
<form method="POST">
	...
	<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-morado transicion-corta">Agregar Parroquias</p>
		</div>
		<div class="y scroll scroll-morado">
			<div class="contenedorx blur blur-blanco borde-morado">
					...
					<input class="text-morado input input-blanco transicion-corta borde-morado" onkeypress="return solotexto(event);" required name="parroquia" type="text" placeholder="Miguel Otero Silva">
					<p class="sub-texto">Ciudad <strong class="texto-rojo texto-borde-negro">*</strong></p>
					<select name="ciudad" class="pointer-morado input input-blanco borde-morado">
					<?php 
						include("../../con_db.php");
						$resultado = mysqli_query($conex, "CALL sp_listar_ciudad()");
		...
		<?php 
	include("ingresar-parroquias.php");
	?>
	</div>
	...
	<div class="u">
		...
		<footer class="pie pie-registro blur blur-morado-suave borde-morado">
				...
				<ul class="menu-pie">
					...
					<!-- Boton atrás -->
					<li><a href="../Nota/agregar-notas2.php"><div class="pointer-morado boton-menu-superior imagen-atras transicion-corta borde-morado"></div></a></li>
					<!-- Boton Hogar -->
