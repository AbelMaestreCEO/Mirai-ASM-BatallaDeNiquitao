...
<head>
	<meta charset="UTF-8">
	<title>Agregar Estados (BdN)</title>
	...
	<div class="v">
		...
		<div class="y scroll scroll-morado">
			<div class="contenedorx blur blur-blanco borde-morado">
					...
					<input class="text-morado input input-blanco transicion-corta borde-morado" onkeypress="return solotexto(event);" required name="estado" type="text" placeholder="Anzoátegui">
				</div>
			</div>
		</div>
		<div class="v">
	...
	<div class="u">
		...
		<footer class="pie pie-registro blur blur-morado-suave borde-morado">
				...
				<ul class="menu-pie">
					...
					<!-- Boton atrás -->
					<li><a href="agregar-municipios.php"><div class="pointer-morado boton-menu-superior imagen-atras transicion-corta borde-morado"></div></a></li>
					<!-- Boton Hogar -->
					...
					<!-- Boton adelante -->
					<li><a href="../Profesor/agregar-profesores.php"><div class="pointer-morado boton-menu-superior imagen-adelante transicion-corta borde-morado"></div></a></li>
