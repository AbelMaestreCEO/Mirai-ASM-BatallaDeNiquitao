...
<head>
	<meta charset="UTF-8">
	<title>Eliminar Estado (BdN)</title>
...
<form method="POST">
	...
	<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-morado transicion-corta">Eliminar Estados</p>
		</div>
		<div class="y scroll scroll-morado">
			<div class="contenedorx blur blur-blanco borde-morado">
					...
					<p class="sub-texto">Estados <strong class="texto-rojo texto-borde-negro">*</strong></p>
