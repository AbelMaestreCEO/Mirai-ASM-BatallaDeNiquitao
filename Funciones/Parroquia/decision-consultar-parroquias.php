	...
	<div class="z zp-alrededor blur blur-blanco scroll scroll-morado borde-morado">
		...
		<div class="x scroll scroll-morado">
			...
			<div class="contenedorx blur blur-blanco borde-morado">
				...
				<!-- Boton Blanco -->
				<a href="consultar-parroquias.php" class="boton boton-activo boton-morado transicion-corta borde-morado">Parroquias</a>
				<!-- Tabla X -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
			...
			<div class="contenedorx blur blur-blanco borde-morado">
				...
				<!-- Boton azul -->
				<a href="consultar-ciudades.php" class="boton boton-activo boton-morado transicion-corta borde-morado">Ciudades</a>
				<!-- Tabla x -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
			...
			<div class="contenedorx blur blur-blanco borde-morado">
				...
				<!-- Boton azul -->
				<a href="consultar-municipios.php" class="boton boton-activo boton-morado transicion-corta borde-morado">Municipios</a>
				<!-- Tabla x -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
			...
			<div class="contenedorx blur blur-blanco borde-morado">
				...
				<!-- Boton azul -->
				<a href="consultar-estados.php" class="boton boton-activo boton-morado transicion-corta borde-morado">Estados</a>
				<!-- Tabla x -->
				<div class="tabla">
					<!-- División -->
					<hr class="blur-azul">
