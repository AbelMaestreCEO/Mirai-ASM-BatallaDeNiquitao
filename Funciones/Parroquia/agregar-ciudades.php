...
<head>
	<meta charset="UTF-8">
	<title>Agregar Ciudades (BdN)</title>
...
<form method="POST">
	...
	<div class="v">
			<p class="titulo-pagina blur blur-blanco borde-morado transicion-corta">Agregar Ciudades</p>
		</div>
		<div class="y scroll scroll-morado">
			<div class="contenedorx blur blur-blanco borde-morado">
					...
					<p class="sub-texto">Ciudad <strong class="texto-rojo texto-borde-negro">*</strong></p>
					<input class="text-morado input input-blanco transicion-corta borde-morado" onkeypress="return solotexto(event);" required name="ciudad" type="text" placeholder="El Tigre">
					<p class="sub-texto">Código Postal <strong class="texto-rojo texto-borde-negro">*</strong></p>
					<input class="text-morado input input-blanco transicion-corta borde-morado" onkeypress="return solonumeros(event);" required name="codigo" type="number" placeholder="6050">
					<p class="sub-texto">Municipio <strong class="texto-rojo texto-borde-negro">*</strong></p>
					<select name="municipio" class="pointer-morado input input-blanco borde-morado">
					<?php 
						include("../../con_db.php");
